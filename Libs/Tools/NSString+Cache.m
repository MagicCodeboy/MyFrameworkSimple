...
+(NSString *)getAppLogo{
    return [[self getBundleID] stringByReplacingOccurrencesOfString:@"com.yiju.joustar" withString:@""];
}
+(NSString *)getJPushKey{
    if ([[self getAppLogo] isEqualToString:@"one"]) {
       return  @"b8e4bc8afbe85c1e";
    } else if ([[self getAppLogo] isEqualToString:@"two"]){
        return  @"b8e4bc8afbe85c1e";
    } else {
        return  @"b8e4bc8afbe85c1e";
    }
...
+(NSString *)getJPushServiceKey{
    if ([[self getAppLogo] isEqualToString:@"one"]) {
        return  @"0061adcd159faa23c77d79f5";
    } else if ([[self getAppLogo] isEqualToString:@"two"]){
        return  @"2dcb50fd284900950e32095b";
    } else {
        return  @"2dcb50fd284900950e32095b";
    }
}
